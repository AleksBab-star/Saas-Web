        ...
        <section className="flex lg:flex-row flex-col lg:items-center lg:justify-between gap-8 py-10 lg:py-16">
            ...
            <div className="flex flex-col gap-6 lg:gap-8 lg:max-w-130 w-full">
                ...
                <div className="flex flex-col gap-4 lg:gap-5">
                    <h1 className="font-['Playfair_Display'] text-[42px] lg:text-[64px] font-bold leading-[1.1] text-white">
                ...
                {/* Кнопки — десктоп: горизонтально, мобайл: вертикально во всю ширину */}
                <div className="flex flex-col lg:flex-row lg:items-center gap-3 lg:gap-4">
                    <button className="flex items-center justify-center gap-2.5 w-full lg:w-auto px-7 py-4 lg:py-3.5 bg-[#81E48A] text-[#041117] font-['Roboto'] font-semibold text-base rounded-xl lg:rounded-lg hover:bg-[#6FD97A] transition order-1 lg:order-2">
                        Start Free Trial
                    ...
                    <button className="w-full lg:w-auto px-7 py-4 lg:py-3.5 bg-white text-[#041117] font-['Roboto'] font-semibold text-base rounded-xl lg:rounded-lg hover:bg-gray-100 transition order-2 lg:order-1">
                        Book a Demo
                    </button>
                </div>

                {/* Dashboard — только мобайл, между кнопками и trusted */}
                <div className="block lg:hidden w-full overflow-hidden rounded-2xl">
                    <img src="/images/dashboard.png" alt="Dashboard preview" className="w-full h-auto"/>
                </div>

                {/* Полупрозрачная секция Trusted By */}
                <div className="bg-white/[0.03] border border-white/[0.08] rounded-2xl px-6 lg:px-8 py-5 lg:py-6 flex flex-col gap-4 lg:gap-5">
                    <p className="font-['Roboto'] text-[#81E48A] text-sm font-medium tracking-wide">Trusted By</p>

                    <div className="flex items-center gap-4 overflow-hidden">
                        <h2 className="font-['Playfair_Display'] text-white text-xl lg:text-2xl font-bold whitespace-nowrap">
                            Thrive with 3,500+ businesses
                        </h2>
                        <svg width="78" height="12" viewBox="0 0 78 12" fill="none" xmlns="http://www.w3.org/2000/svg" className="flex-shrink-0 hidden sm:block">
                    ...
                    <div className="flex items-center gap-6 text-white font-['Roboto'] font-semibold text-sm lg:text-base">
            ...
            {/* Правая часть — dashboard, только десктоп */}
            <div className="hidden lg:block flex-shrink-0 -mr-[140px] w-[58%]">
